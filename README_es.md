<p align="right">
  <b>🇪🇸 Español</b> | <a href="./README.md">🇺🇸 Read in English</a>
</p>
...
Soy estudiante de 3.º año de **Ingeniería en Sistemas de Información** en la **Universidad Tecnológica Nacional (UTN FRRo)** y **Técnico Químico**.

Combino el razonamiento analítico y el modelado de datos con el desarrollo de software y la automatización de procesos. Mi enfoque está centrado en crear soluciones funcionales, eficientes y alineadas con estándares de accesibilidad web (W3C) y buenas prácticas de arquitectura.

- 🎓 **Formación:** Ingeniería en Sistemas de Información @ UTN FRRo
- 🌐 **Idiomas:** Español (Nativo) | Inglés (C1 Advanced — en preparación)
- ⚙️ **Áreas de Interés:** Desarrollo Web Full-Stack, Automatización con n8n, Modelado Relacional e Integración de Agentes de IA.
- 💡 **Actividades:** Participante en desafíos de innovación (Rally Latinoamericano de Innovación) y competencias de programación.
...
### 🛍️ [Paseo de la Fortuna](https://github.com/tu-usuario/paseo-de-la-fortuna)
> **Sistema Web Full-Stack de Fidelización y Promociones**
* **Tecnologías:** PHP, MySQL, JavaScript, Bootstrap, W3C Standards
